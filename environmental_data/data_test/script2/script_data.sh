...
curl -X GET "https://aqs.epa.gov/data/api/sampleData/byBox?email=javiersc@umich.edu&key=carmelosprey42&parameters=pm25&bdate=$beginDate&edate=$endDate&minlat=$lat_min&maxlat=$lat_max&minlon=$lon_min&maxlon=$lon_max" > data_airnow_case1.json
